...
function Card({
  ...
  return (
    <motion.div
      ...
      style={{
        background:
          "linear-gradient(135deg, rgba(61,47,107,0.5) 0%, rgba(26,19,48,0.7) 100%)",
  ...
  return (
    <section className="relative py-24 px-6 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 50%, #2a1f4a 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
          ...
          <Card delay={0.2}>
            ...
            <p className="text-stone-300 leading-relaxed">
              תרגילים פתוחי לב · עבודת גוף · ריקוד · משחק
            </p>
          </Card>
        </div>
        ...
        <Card delay={0.3}>
          <div className="text-center">
            <p className="text-xs text-amber-400/70 uppercase tracking-wider mb-4">
              מחיר השתתפות
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
              ...
              <div
                className="hidden sm:block w-px h-16 bg-amber-400/20"
                aria-hidden="true"
              />
              <div>
